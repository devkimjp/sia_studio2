      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          ...
          <div className="flex flex-col justify-center max-w-xl">
            ...
            <span className="text-2xl font-light text-[#2C2A26] mb-8">₩{product.price.toLocaleString()}</span>
                ...
                <div className="flex gap-4">
                  {sizes.map(size => (
                    <button
                      ...
                      className={`w-12 h-12 flex items-center justify-center border transition-all duration-300 ${selectedSize === size
