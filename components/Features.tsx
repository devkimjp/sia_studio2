    ...
    <section className="bg-[#EBE7DE]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
        ...
        <div className="order-1 lg:order-2 flex flex-col justify-center p-12 lg:p-24 bg-[#EBE7DE]">
          ...
          <h3 className="text-4xl md:text-5xl font-serif mb-8 text-[#2C2A26] leading-tight">
            Materials that tell <br /> a story.
          </h3>
          <p className="text-lg text-[#5D5A53] font-light leading-relaxed mb-12 max-w-md">
            We cherish the imperfect perfection of nature. Every Sia Studio product is crafted from premium vegetable-tanned leather that develops a unique patina over time, recording your life's journey.
          </p>
          <a href="#about" className="inline-block text-sm font-medium uppercase tracking-widest underline underline-offset-8 hover:text-[#8C8881] transition-colors">Read about our leather</a>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
        <div className="flex flex-col justify-center p-12 lg:p-24 bg-[#2C2A26] text-[#F5F2EB]">
          <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#A8A29E] mb-6">The Craft</span>
          ...
          <p className="text-lg text-[#A8A29E] font-light leading-relaxed mb-12 max-w-md">
            Our products are built to last. We use the traditional saddle stitch technique, where two needles pass through the same hole, creating a bond stronger than any machine can achieve.
          </p>
        </div>
